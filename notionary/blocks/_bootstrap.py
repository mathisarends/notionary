...
def bootstrap_blocks() -> None:
    ...
    from notionary.blocks import (bookmark, breadcrumbs, bulleted_list,
                                  callout, child_page, code, column, divider,
                                  embed, equation, file, heading, image_block,
                                  models, numbered_list, paragraph, quote,
                                  table, table_of_contents, todo, toggle,
                                  toggleable_heading, video)
    ...
    from notionary.blocks.divider.divider_models import (CreateDividerBlock,
                                                         DividerBlock)
    from notionary.blocks.embed.embed_models import (CreateEmbedBlock,
                                                     EmbedBlock)
    ...
    from notionary.blocks.numbered_list.numbered_list_models import (
        CreateNumberedListItemBlock, NumberedListItemBlock)
    from notionary.blocks.paragraph.paragraph_models import (
        CreateParagraphBlock, ParagraphBlock)
    from notionary.blocks.pdf.pdf_models import CreatePdfBlock
    from notionary.blocks.quote.quote_models import (CreateQuoteBlock,
                                                     QuoteBlock)
