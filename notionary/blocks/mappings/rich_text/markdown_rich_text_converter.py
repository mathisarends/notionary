...
from notionary.blocks.mappings.rich_text.models import MentionType, RichText, RichTextType, TextAnnotations
...
from notionary.blocks.mappings.rich_text.rich_text_patterns import RichTextPatterns
