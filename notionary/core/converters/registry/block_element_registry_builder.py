...
from notionary.core.converters.elements.list_element import BulletedListElement, NumberedListElement
...
class BlockElementRegistryBuilder:
    ...
    def start_minimal(cls) -> 'BlockElementRegistryBuilder':
        ...
        builder = cls()
        return (builder
                .add_element(HeadingElement)
                .add_element(BulletedListElement)
                .add_element(NumberedListElement)
                .add_element(ParagraphElement))  # Add paragraph last as fallback
    ...
    def add_element(self, element_class: Type[NotionBlockElement]) -> 'BlockElementRegistryBuilder':
        """
    ...
    def add_elements(self, element_classes: List[Type[NotionBlockElement]]) -> 'BlockElementRegistryBuilder':
        """
    ...
    def remove_element(self, element_class: Type[NotionBlockElement]) -> 'BlockElementRegistryBuilder':
        """
    ...
    def move_element_to_end(self, element_class: Type[NotionBlockElement]) -> 'BlockElementRegistryBuilder':
        """
    ...
    @classmethod
    def create_custom_registry(cls, element_classes: List[Type[NotionBlockElement]]) -> BlockElementRegistry:
        """
