...
from notionary.exceptions.database_exceptions import PageNotFoundException, PageOperationError
...
class DatabasePageService:
    ...
    def __init__(self, client: NotionClient, schema: NotionDatabaseSchema, writer: DatabaseWritter):
        self._client = client
        self._schema = schema
        self._writer = writer
