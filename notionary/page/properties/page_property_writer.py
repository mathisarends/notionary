...
class PagePropertyWriter:
    ...
    def _build_property_setters(self) -> dict[PropertyType, Setter]:
        return {
            ...
            PropertyType.RELATION: lambda prop_name, prop_value: self.set_relation_property(
                prop_name, prop_value
            ),
        }
    ...
    async def set_number_property(self, property_name: str, number: Union[int, float]) -> None:
    ...
    async def set_date_property(self, property_name: str, date_value: Union[str, dict]) -> None:
    ...
    async def set_relation_property(self, property_name: str, relation_ids: Union[str, list[str]]) -> None:
