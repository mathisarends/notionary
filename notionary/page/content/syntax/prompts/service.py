...
class SyntaxPromptRegistry:
    def __init__(self, syntax_definition_registry: SyntaxDefinitionRegistry):
        ...
        self._grammar = syntax_definition_registry._markdown_grammar
    ...
    # Individual getters for each syntax element
    ...
    def get_column_prompt(self) -> SyntaxPromptData:
        """Returns combined column prompt with column list and at least 2 columns."""
    ...
    def _get_nesting_info(self) -> str:
        """Returns standardized nesting information based on grammar."""
    ...
    def _get_media_path_usage_notes(self) -> str:
        """Returns standardized path handling notes for media elements."""
        return (
    ...
    def _generate_media_examples(self, start_delimiter: str, end_delimiter: str, media_type: str) -> list[str]:
        """Generate few-shot examples for media elements based on their delimiters."""
        return [
    ...
    def _generate_url_media_examples(
        ...
        """Generate few-shot examples for URL-only media elements."""
