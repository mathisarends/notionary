...
_DESCRIPTORS: dict[PropertyType, PropertyTypeDescriptor] = {
...
def get_descriptor(property_type: PropertyType) -> PropertyTypeDescriptor:
    return _DESCRIPTORS.get(
        property_type,
        PropertyTypeDescriptor(
            display_name=property_type.value.replace("_", " ").title(),
            description="",
        ),
    )
