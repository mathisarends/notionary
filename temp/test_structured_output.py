...
def create_complex_test() -> MarkdownDocumentModel:
    ...
    return MarkdownDocumentModel(
        blocks=[
            # Hauptüberschrift
            HeadingBlock(
                params=HeadingMarkdownBlockParams(text="Project Documentation", level=1)
            ),
            # Einführung
            ParagraphBlock(
            ...
            # Schneller Überblick
            HeadingBlock(
                params=HeadingMarkdownBlockParams(text="Quick Overview", level=2)
            ),
            BulletedListBlock(
            ...
            HeadingBlock(
                params=HeadingMarkdownBlockParams(text="Project Status", level=2)
            ),
            TableBlock(
            ...
            HeadingBlock(
                params=HeadingMarkdownBlockParams(text="Technical Details", level=2)
            ),
            ToggleBlock(
                params=ToggleBlockParams(
                    ...
                    children=[
                        ...
                        HeadingBlock(
                            params=HeadingMarkdownBlockParams(
                                text="Performance Metrics", level=3
                            )
                        ),
                        TableBlock(
                            params=TableMarkdownBlockParams(
            ...
            # Fazit
            HeadingBlock(params=HeadingMarkdownBlockParams(text="Next Steps", level=2)),
            BulletedListBlock(
                params=BulletedListMarkdownBlockParams(
                    texts=[
