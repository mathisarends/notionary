...
def create_toggleable_heading_examples() -> str:
    ...
    return (
        ...
        .toggleable_heading(
            ...
            2,
            lambda t: t
            .paragraph("This section contains high-level project information.")
            .bulleted_list([
        ...
        .toggleable_heading(
            ...
            3,
            lambda t: t
            .paragraph("Detailed technical specifications and constraints:")
            .numbered_list([
        ...
        .toggleable_heading(
            ...
            2,
            lambda t: t
            .paragraph("Major milestones organized by development phase:")
            .toggleable_heading(
