from notionary.page.content.markdown.nodes import BulletedListMarkdownNode
from notionary.page.content.syntax.service import SyntaxRegistry


def test_bulleted_list_markdown_node(syntax_registry: SyntaxRegistry) -> None:
    bulleted_list_syntax = syntax_registry.get_bulleted_list_syntax()
