...
def test_simple_quote(syntax_registry: SyntaxDefinitionRegistry, quote_delimiter: str) -> None:
...
def test_quote_with_different_text(syntax_registry: SyntaxDefinitionRegistry, quote_delimiter: str) -> None:
...
def test_quote_without_children(syntax_registry: SyntaxDefinitionRegistry, quote_delimiter: str) -> None:
...
def test_quote_children_order_preserved(syntax_registry: SyntaxDefinitionRegistry) -> None:
...
def test_quote_with_empty_text(syntax_registry: SyntaxDefinitionRegistry, quote_delimiter: str) -> None:
