...
def test_numbered_list_with_paragraph_child(syntax_registry: SyntaxDefinitionRegistry, indent: str) -> None:
...
def test_numbered_list_with_nested_list_child(syntax_registry: SyntaxDefinitionRegistry, indent: str) -> None:
...
def test_numbered_list_with_multiple_items_and_children(syntax_registry: SyntaxDefinitionRegistry, indent: str) -> None:
...
def test_numbered_list_with_fewer_children_than_items(syntax_registry: SyntaxDefinitionRegistry, indent: str) -> None:
...
def test_numbered_list_with_none_children(syntax_registry: SyntaxDefinitionRegistry) -> None:
    numbered_list = NumberedListMarkdownNode(
...
def test_numbered_list_children_order_preserved(syntax_registry: SyntaxDefinitionRegistry) -> None:
...
def test_numbered_list_numbering_starts_at_one(syntax_registry: SyntaxDefinitionRegistry) -> None:
...
def test_numbered_list_with_ten_items(syntax_registry: SyntaxDefinitionRegistry) -> None:
