...
def test_column_without_width_ratio(syntax_registry: SyntaxDefinitionRegistry, column_delimiter: str) -> None:
...
def test_column_with_width_ratio(syntax_registry: SyntaxDefinitionRegistry, column_delimiter: str) -> None:
...
def test_column_with_children(syntax_registry: SyntaxDefinitionRegistry, column_delimiter: str, indent: str) -> None:
...
def test_column_list_without_columns(syntax_registry: SyntaxDefinitionRegistry, column_list_delimiter: str) -> None:
...
def test_column_list_with_columns(
    syntax_registry: SyntaxDefinitionRegistry, column_list_delimiter: str, column_delimiter: str, indent: str
) -> None:
