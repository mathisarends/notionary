...
def test_complex_documentation_structure():
    ...
    result = (builder
        .h1("API Documentation & Implementation Guide")
            ...
            lambda col: (col
                ...
                .table(
                    ...
                    rows=[
                        ...
                        ["/api/users/{id}", "GET", "Einzelnen Benutzer abrufen", "✅ Aktiv"],
