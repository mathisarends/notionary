...
class TestNotionPageSmoke:
    ...
    async def test_content_operations(self):
        ...
        replace_result = await page.replace_content(
    ...
    async def test_property_operations(self):
        ...
        if property_value is not None:
            try:
                set_result = await page.set_property_value_by_name(
    ...
    async def test_relation_operations(self):
        ...
        try:
            ...
            if relation_property_name:
                ...
                relation_values = await page.get_relation_property_values_by_name(
                    relation_property_name
                )
                print(f"Current relation values: {relation_values}")

                # Get relation options
                relation_options = await page.get_options_for_property(
                    relation_property_name
                )
                if relation_options:
                    ...
                    updated_values = await page.get_relation_property_values_by_name(
                        relation_property_name
                    )
