import unittest
from notionary.converters.elements.bookmarks import  BookmarkElement
...
class TestBookmarkElement(unittest.TestCase):
    def test_match_markdown(self):
        ...
        self.assertTrue(BookmarkElement.match_markdown("[bookmark](https://example.com)"))
        self.assertTrue(BookmarkElement.match_markdown("[bookmark](https://example.com \"Titel\")"))
        self.assertTrue(BookmarkElement.match_markdown("[bookmark](https://example.com \"Titel\" \"Beschreibung\")"))
    ...
    def test_match_notion(self):
        ...
        self.assertTrue(BookmarkElement.match_notion({"type": "bookmark", "bookmark": {"url": "https://example.com"}}))
        
        self.assertFalse(BookmarkElement.match_notion({"type": "paragraph"}))
        self.assertFalse(BookmarkElement.match_notion({"bookmark": {"url": "https://example.com"}}))
    
    def test_markdown_to_notion(self):
        """Test die Konvertierung von Markdown-Bookmarks zu Notion-Bookmark-Blöcken."""
        simple_result = BookmarkElement.markdown_to_notion("[bookmark](https://example.com)")
        ...
        titled_result = BookmarkElement.markdown_to_notion("[bookmark](https://example.com \"Beispiel-Titel\")")
        self.assertEqual(titled_result["type"], "bookmark")
        self.assertEqual(titled_result["bookmark"]["url"], "https://example.com")
        self.assertEqual(titled_result["bookmark"]["caption"][0]["text"]["content"], "Beispiel-Titel")
        
        full_result = BookmarkElement.markdown_to_notion("[bookmark](https://example.com \"Beispiel-Titel\" \"Eine Beschreibung\")")
        self.assertEqual(full_result["type"], "bookmark")
        self.assertEqual(full_result["bookmark"]["url"], "https://example.com")
        self.assertEqual(full_result["bookmark"]["caption"][0]["text"]["content"], "Beispiel-Titel")
        self.assertEqual(full_result["bookmark"]["caption"][2]["text"]["content"], "Eine Beschreibung")
    ...
    def test_notion_to_markdown(self):
        ...
        self.assertEqual(BookmarkElement.notion_to_markdown(simple_block), "[bookmark](https://example.com)")
        ...
        self.assertEqual(BookmarkElement.notion_to_markdown(titled_block), 
        ...
        self.assertEqual(BookmarkElement.notion_to_markdown(full_block), 
