...
class TestImageElement(unittest.TestCase):
    ...
    def test_match_markdown(self):
        ...
        self.assertTrue(
            ImageElement.match_markdown("![Caption](https://example.com/image.jpg)")
        )
        self.assertTrue(
            ImageElement.match_markdown("![](https://example.com/image.jpg)")
        )
        self.assertTrue(
            ImageElement.match_markdown(
                '![Caption](https://example.com/image.jpg "alt text")'
            )
        )
        self.assertFalse(
            ImageElement.match_markdown("[Caption](https://example.com/image.jpg)")
    ...
    def test_markdown_to_notion(self):
        ...
        expected_with_caption = {
            ...
            "image": {
                ...
                "caption": [{"type": "text", "text": {"content": "Test Caption"}}],
            },
        }
        self.assertEqual(
            ImageElement.markdown_to_notion(image_with_caption), expected_with_caption
        )
        ...
        self.assertEqual(
            ImageElement.markdown_to_notion(image_without_caption),
            expected_without_caption,
        )
    ...
    def test_notion_to_markdown(self):
        ...
        notion_file_image = {
            ...
            "image": {
                "type": "file",
                "file": {"url": "https://example.com/uploaded.jpg"},
            },
        }
        self.assertEqual(
        ...
        # Test missing URL
        invalid_image = {"type": "image", "image": {"type": "external", "external": {}}}
    ...
    def test_extract_text_content(self):
        ...
        plain_text = [{"plain_text": "Another caption"}]
        self.assertEqual(
            ImageElement._extract_text_content(plain_text), "Another caption"
        )
