import unittest
from notionary.converters.elements.quotes import QuoteElement
...
class TestQuoteElement(unittest.TestCase):
    ...
    def test_match_markdown(self):
        ...
        self.assertTrue(QuoteElement.match_markdown("> [background:blue] Colored quote"))
    ...
    def test_markdown_to_notion_default_color(self):
        ...
        self.assertEqual(block["quote"]["rich_text"][0]["text"]["content"], "This is a test quote")
    ...
    def test_markdown_to_notion_with_color(self):
        ...
        self.assertEqual(block["quote"]["rich_text"][0]["text"]["content"], "This is a blue quote")
    ...
    def test_notion_to_markdown_with_color(self):
        ...
        block = {
            "type": "quote",
            "quote": {
                "rich_text": [{"type": "text", "text": {"content": "Colorful content"}}],
    ...
    def test_multiline_quote(self):
        ...
        md = "> Line one\n> Line two\n> Line three"
        block = QuoteElement.markdown_to_notion(md)
        self.assertIn("Line one\nLine two\nLine three", block["quote"]["rich_text"][0]["text"]["content"])
...
"""
        ...
        self.assertIn("Quote one line", matches[0][2]["quote"]["rich_text"][0]["text"]["content"])
