...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('[video](https://example.com/abc.mp4 "Demo Video")', "https://example.com/abc.mp4", "Demo Video"),
        ("[video](https://youtu.be/dQw4w9WgXcQ)", "https://www.youtube.com/watch?v=dQw4w9WgXcQ", ""),
        ('[video](https://www.youtube.com/watch?v=dQw4w9WgXcQ "Rick")', "https://www.youtube.com/watch?v=dQw4w9WgXcQ", "Rick"),
    ]
)
...
def test_roundtrip():
    ...
    for md in cases:
        ...
        # Should result in the same markdown (except possible YouTube normalization)
