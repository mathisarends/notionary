...
def test_match_markdown_valid_documents():
    ...
    assert DocumentElement.match_markdown('[document](https://drive.google.com/file/d/123 "My Report")')
    assert DocumentElement.match_markdown('   [document](https://abc.com/x.docx)   ')
    assert DocumentElement.match_markdown('[document](https://example.com/y.xlsx "Finanzen Q4")')
            ...
            [
                {
                    ...
                    "file": {
                        ...
                        "caption": [{"type": "text", "text": {"content": "Bericht 2024"}}],
                    },
                },
