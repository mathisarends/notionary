...
class TestUserNameIdResolver:
    ...
    @pytest.mark.asyncio
    async def test_resolve_user_id_with_valid_uuid(self, resolver: PersonNameIdResolver) -> None:
        result = await resolver.resolve_name_to_id("12345678-1234-1234-1234-123456789abc")
        assert result == "user-123"

    @pytest.mark.asyncio
    async def test_resolve_user_id_with_name_search(self, resolver: PersonNameIdResolver) -> None:
    ...
    @pytest.mark.asyncio
    async def test_resolve_user_name_with_empty_id(self, resolver: PersonNameIdResolver) -> None:
        result = await resolver.resolve_id_to_name("")
        assert result is None

    @pytest.mark.asyncio
    async def test_resolve_user_name_with_none(self, resolver: PersonNameIdResolver) -> None:
    ...
    @pytest.mark.asyncio
    async def test_resolve_user_name_success(self, resolver: PersonNameIdResolver) -> None:
