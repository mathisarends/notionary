...
class TestPageNameIdResolver:
    @pytest.mark.asyncio
    async def test_resolve_page_id_with_empty_name(
    ...
    @pytest.mark.asyncio
    async def test_resolve_page_id_with_none(
        self, resolver: PageNameIdResolver
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_resolve_page_id_with_valid_uuid(
        self, resolver: PageNameIdResolver
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_resolve_page_name_with_empty_id(
        self, resolver: PageNameIdResolver
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_resolve_page_name_with_none(
        self, resolver: PageNameIdResolver
    ) -> None:
